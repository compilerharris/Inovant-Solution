(function () {
    ...
    var y, z = document,
        ...
        Sb = eb && parseInt(Aa.split("Firefox/index.html")[1], 10) < 4,
...
Highcharts.c = {
    colors: "#007bb9 #ee6c24 #ED561B #DDDF00 #24CBE5 #64E572 #FF9655 #FFF263 #6AF9C4".split(" "),
    chart: {
    ...
    tooltip: {
        style: {
            color: "#444444",
            font: "14px Futura MdCn BT"
        }
    },
    title: {
        style: {
            color: "#444444",
            font: "bold 14px Futura MdCn BT"
        }
    },
    subtitle: {
        style: {
            color: "#444444",
            font: "12px Futura MdCn BT"
        }
    },
    xAxis: {
        gridLineWidth: 0,
...
jQuery(document).ready(function () {
    ...
    jQuery("ul.loanproduct-nav li").click(function () {
        "active" != jQuery(this).attr("class") && (jQuery(this).addClass("active").siblings().removeClass("active"), m = jQuery(this).attr("id"), "home-loan" == m ? F("Loan Amount", 1E7, 5E4, 25E5, 20, 10.5, 30, 0.5, 240) : "personal-loan" == m ? F("Personal Loan Amount", 15E5, 1E4, 35E4, 25, 17.5, 5, 0.25, 36) : "car-loan" == m && F("Car Loan Amount", 2E6, 1E4, 4E5, 20, 12.5, 7, 0.25, 60), G());
        return !1
    });
    ...
    jQuery("#loanamount").blur(function () {
        jQuery("#loanamount").val(currencyformat(Math.round(jQuery("#loanamount").val().replace(/[^\d\.]/g, ""))))
    });
    ...
    F("Loan Amount", 1E7, 5E4, 25E5, 20, 10.5, 30, 0.5, 240);
    G()
});
...
function F(a, d, w, b, y, z, J, K, H) {
    ...
    jQuery("#loanamount").val(currencyformat(b));
    ...
    n = jQuery("#loanamountslider").slider({
        ...
        step: w,
        slide: function (a, b) {
            jQuery("#loanamount").val(currencyformat(Math.round(b.value)))
        },
        change: function (a) {
            a.originalEvent && G()
        }
...
function L() {
    ...
    jQuery("#emiamount span").text(currencyformat(Math.round(g)));
    jQuery("#emitotalinterest span").text(currencyformat(Math.round(g * f - c)));
    jQuery("#emitotalamount span").text(currencyformat(Math.round(g * f)));
    t = [];
    u = [];
    v = [];
    x = [];
...
function O() {
    ...
    for (var a = 0, d = 0, w = t.length; d < w; d++) {
        var b = t[d];
        l += '<tr class="yearlypaymentdetails"><td id="year' + b + '" class="paymentyear toggle">' + b + '</td><td class="currency">\u20b9 ' + Globalize.format(u[b], "n", "en-IN") + '</td><td class="currency">\u20b9 ' + Globalize.format(v[b], "n", "en-IN") + '</td><td class="currency">\u20b9 ' +
            Globalize.format(u[b] + v[b], "n", "en-IN") + '</td><td class="currency">\u20b9 ' + Globalize.format(x[b], "n", "en-IN") + "</td></tr>";
        l += '<tr id="monthyear' + b + '" class="monthlypaymentdetails"><td class="monthyearwrapper" colspan="5"><div id="monthlypaymentcontainer"><table>';
        for (var y = A.length; a < y && A[a].getFullYear() == b;) l += '<tr><td class="paymentmonthyear">' + E[A[a].getMonth()] + '</td><td class="currency">\u20b9 ' + Globalize.format(B[a], "n", "en-IN") + '</td><td class="currency">\u20b9 ' + Globalize.format(C[a], "n", "en-IN") + '</td><td class="currency">\u20b9 ' + Globalize.format(B[a] + C[a], "n", "en-IN") + '</td><td class="currency">\u20b9 ' + Globalize.format(D[a++], "n", "en-IN") + "</td></tr>";
        l += "</table></div></td></tr>"
    }
    l += "</table>";

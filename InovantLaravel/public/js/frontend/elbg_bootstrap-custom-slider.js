    ...
    var Slider = function(element, options) {
        ...
        if (parent.hasClass('slider') === true) {
            ...
            this.picker = $('<div class="slider">'+
                ...
                '<div class="slider-handle"></div>'+
                '</div>'+
                '<div id="tooltip" class="tooltip"><div class="tooltip-arrow"></div><span class="value-notation"></span><div class="tooltip-inner"></div></div>'+
        ...
        // First unbind mouse event. To stop multiple events binding for same event.
        this.picker.off({
    ...
    Slider.prototype = {
        ...
        layout: function(){
            ...
            if (this.range) {
                ...
                {
                    if(this.tooltipInner.outerWidth() == 0 && $.trim(this.tooltipInner.html()) != '')
                    {
                        var noOfDigitsInSliderValue = String(this.tooltipInner.html()).replace(/,/g, '').length;
                        var fontwidthOfEachDigit = 13;
                        if(isMobileSite()) fontwidthOfEachDigit = 9.5;
                        noOfDigitsInSliderValue *= fontwidthOfEachDigit;
                        this.tooltip[0].style[this.stylePos] = (  ( (positionPercentages[0]/100) * this.picker.outerWidth() - (noOfDigitsInSliderValue)/2 )) +'px';
                    }else
                    {
                        this.tooltip[0].style[this.stylePos] = (  ( (positionPercentages[0]/100) * this.picker.outerWidth() - this.tooltipInner.outerWidth()/2 )) +'px';
                    }
